...
DENY_PATTERNS = [
    ...
    # Decision handles: a capital D followed by one to three digits (case-folded).
    # Written as a description rather than examples: literal instances would be
    # flagged by the private-side pre-push check, and a gate that always fails
